...
### Economics | Data Analytics | Econometrics | Machine Learning

**M.Sc. Economics (Data Analytics)** — Symbiosis School of Economics, Pune
...
`Data Cleaning` `EDA` `Statistical Inference` `Hypothesis Testing` `Regression` `Time Series`
